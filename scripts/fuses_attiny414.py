...
BOD_LVL_BODLEVEL0_gc = (0x00 << 5)  # 1.8 V
BOD_LVL_BODLEVEL2_gc = (0x02 << 5)  # 2.6 V
BOD_LVL_BODLEVEL7_gc = (0x07 << 5)  # 4.2 V

bod_lvl_map = {
    1.80: BOD_LVL_BODLEVEL0_gc,
    2.60: BOD_LVL_BODLEVEL2_gc,
    4.20: BOD_LVL_BODLEVEL7_gc,
}
...
def build_fuses(config):
    ...
    bod = BOD_SAMPFREQ_125HZ_gc | BOD_ACTIVE_ENABLED_gc | BOD_SLEEP_DIS_gc
